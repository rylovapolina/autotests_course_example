...
def everything_for_your_cat(cats_data):
    # Здесь нужно написать коl
    """ Функция оптимизирует хранение данных владельцев и его питомцев
                    :param: cats_data - кортеж
                    :return: our_str - отформатированная строка """
    res = {}
    for item in cats_data:
        full_name = f'{item[2]} {item[3]}'
        cat_data = f'{item[0]}, {item[1]}'
        if full_name in res:
            res[full_name] = f'{res[full_name]}; {cat_data}'
        else:
            res[full_name] = cat_data
    our_str = ''
