...
class PublicTransport:
    def __init__(self, brand, engine_power, year, color, max_speed, *args):
        self.brand = brand
    ...
    @property
    def info(self):
        """ Свойство возвращает информацию """
        return print(self.brand, self.color, self.year, self._engine_power)


class Bus(PublicTransport):
    def __init__(self, brand, engine_power, year, color, max_speed, passengers, park, fare, *args):
        super().__init__(brand, engine_power, year, color, max_speed, *args)
    ...
    @property
    def park(self):
        """ Свойство возвращает парк """
        return self.__park

    @park.setter
    def park(self, value):
        """ Свойство проверяет, входит ли парк в диапазон"""
        assert 1000 <= value <= 9999
        self.__park = value


class Tram(PublicTransport):
    def __init__(self, brand, engine_power, year, color, max_speed, route, path, fare,  *args):
        super().__init__(brand, engine_power, year, color, max_speed, *args)
        self.__route = route
        self.path = path
        self._fare = fare
    ...
    @property
    def how_long(self):
        """ Свойство вычисляет время прохождения пути"""
